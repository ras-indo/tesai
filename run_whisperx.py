...
✅ Fix NumPy 2.x & ctranslate2 Python 3.10 incompatibility
"""
import os
import sys
import subprocess
...
def transcribe_with_diarization(audio_file):
    ...
    try:
        ...
        print(f"   ✅ Diarization successful, {len(diarize_segments)} speaker segments")
    except Exception as e:
